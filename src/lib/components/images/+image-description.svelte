...
<Stack direction={Direction.Horizontal} spacing={1.5}>
    ...
    <ImageComponent image_url={image_url} size={20} alt_text={image?.description || 'No description provided'} style="box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.3);" aspect_ratio={3 / 2} />
